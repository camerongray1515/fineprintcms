<script type="text/javascript" src="<?php echo base_url('assets/js/fineprint.blocks.js'); ?>"></script>
...
<form class="form-horizontal" action="<?php echo admin_url('blocks/do_add/no_ajax'); ?>" method="POST" id="block-form">
	<div class="control-group">
		<label class="control-label" for="title">Title</label>
		<div class="controls">
			<input type="text" id="title" name="title" placeholder="A descriptive name for your block e.g. 'Right Sidebar Blocks'" class="input-xxlarge" value="<?php echo $title; ?>">
		</div>
	</div>
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" id="alias" name="alias" placeholder="A short name to use when including your block e.g. 'sidebar-right'" class="input-xxlarge" value="<?php echo $alias; ?>">
		</div>
	</div>
	...
	<div class="form-actions">
		<?php echo top_buttons_button('add', 'Save Block', 'success', 'hdd'); ?>
