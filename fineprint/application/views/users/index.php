...
<table class="table table-hover">
	...
	<tbody>
		<?php foreach ($users as $user): ?>
			<tr data-page-id="<?php echo $user->id; ?>">
				...
				<td>
					<a class="btn btn-danger delete-button" href="<?php echo admin_url("users/delete/{$user->id}"); ?>" data-page-id="<?php echo $user->id; ?>"><i class="icon-trash icon-white"></i> Delete</a>
